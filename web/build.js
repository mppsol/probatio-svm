...
<body><main class="shell">
  ...
  <section aria-labelledby="roster-title"><h2 class="section-label" id="roster-title">Choose a candidate</h2><p class="roster-note">Six illustrative agents — each a recorded certification episode. In production, you bring the agent you’re about to trust.</p><div class="roster" id="roster" role="radiogroup" aria-label="Candidate agents">${rosterMarkup()}</div></section>
  ...
  <section class="cta"><div><h2>Want to certify your own agent?</h2><p>In production, Probatio is built to replay the agent you’re about to trust — brought by its developer or by the vault about to delegate to it — and certify it from account state before it manages real capital.</p><p>Verdicts are computed offline by reading account state as ground truth — nothing to bypass.</p></div><a href="https://github.com/psyto/probatio-svm">See how to certify an agent →</a></section>
